...
function draw() {
	...
	left.position(camera.position.x,camera.position.y);
	right.position(camera.position.x,camera.position.y);
    down.position(mouse.x+6,mouse.y-3.5);
   up.position(mouse.x+6,mouse.y-4.5);
...
function mouseControl(){
	for (var i = 0; i < touches.length; i++) {
		if(touches[i].y===down.y&&touches[i].x===down.x){
			bullet2.velocityX=-12
			bullet3.velocityX=12
			bullet4.velocityX=-12
			bullet5.velocityY=-12
		...
		else if (touches[i].y===up.y&&touches[i].x===up.x){
			bullet2.velocityX=-12
	bullet3.velocityX=12
	bullet4.velocityX=-12
	bullet5.velocityY=-12
	...
	mouse.y+=10
	  mouse.changeAnimation("moused",mouse_down)
		...
		else if(touches[i].y===left.y&&touches[i].x===left.x){
			bullet2.velocityX=-12
	bullet3.velocityX=12
	bullet4.velocityX=-12
	bullet5.velocityY=-12
	...
	bullet.velocityX=12
	  ...
	  mouse.changeAnimation("mousel",mouse_left)
		...
		else if(touches[i].y===right.y&&touches[i].x===right.x){
			bullet2.velocityX=-12
			bullet3.velocityX=12
			bullet4.velocityX=-12
			bullet5.velocityY=-12	
